...
import { slugToModel, getStorageOptions, storageLabel } from "@/lib/sellUtils";
...
export default async function MemoryPage({
  ...
  const storageOptions = getStorageOptions(modelSlug);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {storageOptions.map((storage) => (
            ...
            >
              ...
              <span className="text-xs text-gray-400 mt-1 group-hover:text-green-400 transition-colors">
                Chọn →
              </span>
            </a>
          ))}
        ...
        <div className="mt-8 bg-green-50 border border-green-100 rounded-2xl p-4 text-sm text-gray-600 flex gap-3">
          ...
          <span>
            Không chắc dung lượng? Vào <strong>Cài đặt</strong> →{" "}
            <strong>Cài đặt chung</strong> → <strong>Giới thiệu</strong> → xem dòng{" "}
